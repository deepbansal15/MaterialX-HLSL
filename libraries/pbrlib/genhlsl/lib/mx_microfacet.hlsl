...
// Enforce that given normal is forward-facing from specified view direction.
...
// Generate a uniform-weighted sample on unit hemisphere.
...
// Generate a cosine-weighted sample on unit hemisphere.
